...
df_hol_train= pd.concat([df_vday_train,df_mday_train,df_fday_train,df_iday_train,df_thg_train,df_hal_train,df_nye_train], axis=1)
...
df_hol_test= pd.concat([df_vday_test,df_mday_test,df_fday_test,df_iday_test,df_thg_test,df_hal_test,df_nye_test], axis=1)
...
df_hol_train= pd.concat([df_hol_train,df_vday_train,df_mday_train,df_fday_train,df_iday_train,df_thg_train,df_hal_train,df_nye_train], axis=1)
...
df_hol_test= pd.concat([df_hol_test,df_vday_test,df_mday_test,df_fday_test,df_iday_test,df_thg_test,df_hal_test,df_nye_test], axis=1)
...
gd_sr.fit(df_fin_train, y_train)

best_parameters = gd_sr.best_params_  
print(best_parameters)

#best_parameters = {'bootstrap': False, 'max_features': None, 'min_samples_leaf': 50, 'n_estimators': 100}